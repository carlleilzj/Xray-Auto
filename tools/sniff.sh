...
watch_traffic() {
    ...
    tail -f "$LOG_FILE" | awk '{
        if ($5 == "accepted") {
            ...
            # 这里的数字 (15, 22, 25, 60) 必须和上面 printf 里的完全一样
            printf "\033[36m%-15s\033[0m \033[33m%-22s\033[0m \033[35m%-25s\033[0m \033[32m%-60s\033[0m \033[37m%s\033[0m\n", substr($2,1,12), $4, $7$8$9, $6, $11
        }
    }'
}
